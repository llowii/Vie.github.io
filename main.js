...
document.querySelectorAll('.activités__img').forEach(item => {
...
const import_activités_container = document.querySelector('.import_activités_container');
const stockage_activités_container = document.querySelector('.stockage_activités_container');
const distribution_activités_container = document.querySelector('.distribution_activités_container');
const ventes_activités_container = document.querySelector('.ventes_activités_container');
const imp = document.querySelector('.imp');
const sto = document.querySelector('.sto');
const dis = document.querySelector('.dis');
const ven = document.querySelector('.ven');
import_activités_container.addEventListener('click', function(){
    imp.style.opacity = "1";
    sto.style.opacity = "0";
    dis.style.opacity = "0";
    ven.style.opacity = "0";
});
stockage_activités_container.addEventListener('click', function(){
    imp.style.opacity = "0";
    sto.style.opacity = "1";
    dis.style.opacity = "0";
    ven.style.opacity = "0";
});
distribution_activités_container.addEventListener('click', function(){
    imp.style.opacity = "0";
    sto.style.opacity = "0";
    dis.style.opacity = "1";
    ven.style.opacity = "0";
});
ventes_activités_container.addEventListener('click', function(){
    imp.style.opacity = "0";
    sto.style.opacity = "0";
    dis.style.opacity = "0";
    ven.style.opacity = "1";
...
var nos_activités = document.querySelector('#nos_activités_section').offsetHeight;
...
const link_nos_activités = document.querySelector('.nav-link_nos_activités');
...
window.addEventListener('scroll', function(){
    if (window.pageYOffset >= acceuil && window.pageYOffset <= acceuil + nos_activités - 1 ) {
        link_nos_activités.style.color= "#0984e3";
    } else {
        link_nos_activités.style.color= "#2c3335";
    }
});
window.addEventListener('scroll', function(){
    if (window.pageYOffset >= acceuil + nos_activités && window.pageYOffset <= acceuil + nos_activités + nos_agences - 1 ) {
...
window.addEventListener('scroll', function(){
    if (window.pageYOffset >= acceuil + nos_activités + nos_agences && window.pageYOffset <= acceuil + nos_activités + nos_agences + a_propos - contact - 1 ) {
...
window.addEventListener('scroll', function(){
    if (window.pageYOffset >= acceuil + nos_activités + nos_agences + a_propos - contact && window.pageYOffset <= acceuil + nos_activités + nos_agences + a_propos +contact - 1 ) {
